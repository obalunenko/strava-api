...
type GetEffortsBySegmentIDOK struct {
	Payload []*models2.DetailedSegmentEffort
}
...
func (o *GetEffortsBySegmentIDOK) GetPayload() []*models2.DetailedSegmentEffort {
	return o.Payload
}
...
func (o *GetEffortsBySegmentIDDefault) GetPayload() *models2.Fault {
	return o.Payload
}
