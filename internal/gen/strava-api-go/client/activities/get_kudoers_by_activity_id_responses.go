...
type GetKudoersByActivityIDOK struct {
	Payload []*models2.SummaryAthlete
}
...
func (o *GetKudoersByActivityIDOK) GetPayload() []*models2.SummaryAthlete {
	return o.Payload
}
...
func (o *GetKudoersByActivityIDDefault) GetPayload() *models2.Fault {
	return o.Payload
}
