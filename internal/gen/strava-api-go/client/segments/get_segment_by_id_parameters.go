...
func NewGetSegmentByIDParams() *GetSegmentByIDParams {
	return NewGetSegmentByIDParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetSegmentByIDParams].
